...
typedef enum {
	CLIENT_TRANSFORM_NONE = 0,
	CLIENT_TRANSFORM_BOB,
	CLIENT_TRANSFORM_ROTATE,
	CLIENT_TRANSFORM_BOB_AND_ROTATE
} clientTransformAnim_t;
...
typedef struct entityState_s {
	...
	clientTransformAnim_t clientTransformAnim;
...
// jmarshall - new serialization code
...
// This has to match in the engine and the game code!
